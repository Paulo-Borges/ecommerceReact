...
const Headers = (props) => {
  ...
  return (
    <header className="flex justify-between w-[1440px] max-[1439px]:w-[1100px] max-[1114px]:w-[800px]  max-[640px]:w-[600px] items-center pt-4 max-[375px]:py-0 border-b max-[375px]:border-none border-gray-300 m-auto max-[375px]:mx-3 ">
